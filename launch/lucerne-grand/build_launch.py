...
<section id="neighbours" data-title="The neighbours">
  <div class="wrap">
    ...
    <div class="eyebrow" style="margin-top:72px">Lake Grande, the sales behind that first row</div>
    <table class="jtx reveal"><thead><tr><th>Sold</th><th>Floor</th><th class="n">Size</th><th>Type</th><th class="n">Price</th><th class="n">psf</th></tr></thead><tbody>{{JTX}}</tbody></table>
    <div class="note">Every Lake Grande sale of a 3 or 4-bedroom this year. Source: URA Realis via the JND vault, August 2026.</div>
  </div>
</section>
